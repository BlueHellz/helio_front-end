  ...
  void paint(Canvas canvas, Size size) {
    ...
    for (int i = 0; i < radii.length; i++) {
      if (i < radii.length - 1) {
        final paint = Paint()
          ..color =
              i == 0 ? KooyohColors.border : KooyohColors.accent
          ..style = PaintingStyle.stroke
          ..strokeWidth = 1.0;
...
class _LandingHeroSolarPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    final rayPaint = Paint()
      ..color = KooyohColors.accent.withValues(alpha: 0.35)
      ..strokeWidth = 1
      ..style = PaintingStyle.stroke;
    ...
    final sunCore = Paint()
      ..color = KooyohColors.amber.withValues(alpha: 0.9)
      ..style = PaintingStyle.fill;
...
class _BrowserHomeownerPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    final path = Path()
      ...
      ..close();
    canvas.drawPath(path, Paint()..color = KooyohColors.surface);
    canvas.drawPath(path, Paint()
      ..color = KooyohColors.border
      ..style = PaintingStyle.stroke
      ..strokeWidth = 1);
    final panelP = Paint()
      ..color = KooyohColors.green.withValues(alpha: 0.35)
      ..style = PaintingStyle.fill;
    for (int i = 0; i < 4; i++) {
      final r = RRect.fromRectAndRadius(
        Rect.fromLTWH(
    ...
    canvas.drawRRect(bubble, Paint()..color = KooyohColors.background);
    canvas.drawRRect(
      bubble,
      Paint()
        ..color = KooyohColors.accent
...
class _BrowserOrgDashPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    canvas.drawRRect(sidebar, Paint()..color = KooyohColors.background);
    canvas.drawRRect(
      sidebar,
      Paint()
        ..color = KooyohColors.border
    ...
    for (int i = 0; i < 4; i++) {
      canvas.drawRRect(
        ...
        Paint()..color = KooyohColors.border.withValues(alpha: 0.4),
      );
    }
    ...
    for (int c = 0; c < 2; c++) {
      for (int r = 0; r < 2; r++) {
        ...
        canvas.drawRRect(card, Paint()..color = KooyohColors.surface);
        canvas.drawRRect(
          card,
          Paint()
            ..color = KooyohColors.border
        ...
        canvas.drawRRect(
          ...
          Paint()..color = KooyohColors.accent.withValues(alpha: 0.3),
        );
      }
    }
  }
...
void _paintBrowserChrome(Canvas canvas, Size size) {
  final outer = RRect.fromRectAndRadius(
    ...
    Radius.circular(KooyohRadius.card),
  );
  canvas.drawRRect(outer, Paint()..color = KooyohColors.surface);
  canvas.drawRRect(
    outer,
    Paint()
      ..color = KooyohColors.border
  ...
  for (int i = 0; i < 3; i++) {
    canvas.drawCircle(Offset(18.0 + i * 14, 22), 4,
        Paint()..color = KooyohColors.border);
  }
  final bar = RRect.fromRectAndRadius(
    Rect.fromLTWH(54, 14, size.width - 68, 18),
    const Radius.circular(6),
  );
  canvas.drawRRect(bar, Paint()..color = KooyohColors.background);
  canvas.drawRRect(
    bar,
    Paint()
      ..color = KooyohColors.border
...
class _EvIsoPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    final border = Paint()
      ...
      ..style = PaintingStyle.stroke
      ..strokeWidth = 1;
    final fill = Paint()..color = KooyohColors.surface;
    ...
    canvas.drawPath(
      Path()
        ...
        ..lineTo(cx - 12, cy + 0)
        ..close(),
      Paint()..color = KooyohColors.accent.withValues(alpha: 0.12),
    );

    // Connector head
    canvas.drawCircle(Offset(cx - 52, cy - 12), 5,
        Paint()..color = KooyohColors.accent);
  }
...
class _PoolPeopleRoofPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    final roof = Path()
      ...
      ..lineTo(cx - 88, cy + 6)
      ..close();
    canvas.drawPath(roof, Paint()..color = KooyohColors.surface);
    canvas.drawPath(
      roof,
      Paint()
        ..color = KooyohColors.border
    ...
    final panel = Paint()..color = KooyohColors.green.withValues(alpha: 0.28);
    for (int i = -2; i <= 2; i++) {
      final r = RRect.fromRectAndRadius(
    ...
    person(Offset(cx - 108, cy + 18), KooyohColors.accent);
    person(Offset(cx + 108, cy + 18), KooyohColors.textBody);
    person(Offset(cx - 40, cy + 52), KooyohColors.green);
    person(Offset(cx + 44, cy + 52), KooyohColors.textBody);
  }
