...
class OrgOrgChatDesignContent {
  ...
  static const fullDesign = 'Full Design';
  static const readyTitle = 'Ready to design';
  static const readyBody =
      'Describe the project or enter the address.';
}
